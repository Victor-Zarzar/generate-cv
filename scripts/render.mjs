...
function certificatesHtml(certificates) {
  return certificates
    .map((c) => {
      const links = (c.links ?? [])
        .map(
...
<div class="item">
  ...
  <div class="tech-line">${escapeHtml(c.issuer)} — ${escapeHtml(c.date)}</div>
